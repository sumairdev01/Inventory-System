            ...
            <form method="POST" action="{{ route('sales.store') }}" class="space-y-6" id="sale-form">
                            ...
                            <tr class="product-row">
                                ...
                                <td class="px-4 py-2">
                                    ...
                                    <select name="products[0][product_id]"
                                        class="product-select w-full border rounded-lg p-2" required>
                                ...
                                <td class="px-4 py-2">
                                    ...
                                    <input type="number" name="products[0][quantity]"
                                        class="product-qty w-full border rounded-lg p-2" min="1" value="1" required>
                                ...
                                <td class="px-4 py-2">
                                    ...
                                    <button type="button" class="remove-row bg-red-100 text-red-600 px-2 py-1 rounded"
                ...
                <div class="flex justify-between items-center bg-slate-50 p-4 rounded-lg mt-4 border border-slate-100">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <input type="number" name="paid_amount" id="paid-amount" step="0.01" min="0"
                            class="border rounded-lg p-2 w-32 font-mono text-indigo-600 font-bold" placeholder="0.00">
                ...
                <div class="pt-4 flex justify-end">
                    <button type="submit"
                        class="w-full md:w-max bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white px-10 py-3 rounded-xl font-bold shadow-lg shadow-emerald-200 transition-all duration-200 active:scale-[0.98] flex items-center justify-center">
