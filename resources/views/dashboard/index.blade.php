            ...
            <div class="mb-8">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div>
                        ...
                        <h1 class="text-2xl font-semibold text-gray-900">Good
                            {{ now()->format('A') == 'AM' ? 'Morning' : 'Afternoon' }}, {{ auth()->user()->name }}</h1>
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('sales.create') }}"
                            class="bg-emerald-50 text-emerald-700 hover:text-emerald-800 px-4 py-2 rounded-lg text-sm font-bold border border-emerald-100 hover:border-emerald-200 transition-all flex items-center gap-2 shadow-sm">
                        ...
                        <a href="{{ route('purchases.create') }}"
                            class="bg-gradient-to-r from-teal-600 to-emerald-600 text-white px-4 py-2 rounded-lg text-sm font-bold hover:from-teal-700 hover:to-emerald-700 transition-all flex items-center gap-2 shadow-md shadow-emerald-100">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="bg-white rounded-xl p-6 border border-gray-100">
                        ...
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span
                                class="text-xs font-medium text-blue-600 bg-blue-50 px-2 py-1 rounded-full">Active</span>
                    ...
                    <div class="bg-white rounded-xl p-6 border border-gray-100">
                        ...
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span
                                class="text-xs font-medium {{ $lowStockCount > 0 ? 'text-yellow-600 bg-yellow-50' : 'text-green-600 bg-green-50' }} px-2 py-1 rounded-full">
                        ...
                        <div class="text-2xl font-bold {{ $lowStockCount > 0 ? 'text-yellow-600' : 'text-gray-900' }}">
                            {{ $lowStockCount }}</div>
                            ...
                            @foreach(range(1, 5) as $i)
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div
                                            class="w-8 h-8 bg-gray-100 rounded-lg flex items-center justify-center text-xs font-medium text-gray-600">
                        ...
                        <div class="space-y-4">
                            ...
                            @forelse($recentTransactions as $tx)
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div
                                        class="w-8 h-8 rounded-lg {{ $tx->type == 'in' ? 'bg-green-50' : 'bg-red-50' }} flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <p class="text-sm font-medium text-gray-900 truncate">{{ $tx->product->name }}
                                            </p>

                                            <span
                                                class="text-xs text-gray-400">{{ $tx->created_at->diffForHumans() }}</span>
                    ...
                    <div class="bg-white rounded-xl border border-gray-100 p-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div>
                                ...
                                <span
                                    class="text-2xl font-bold text-gray-900">{{ \App\Models\Supplier::count() }}</span>
