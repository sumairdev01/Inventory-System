...
<div id="sidebar" 
    ...
    <div class="flex items-center h-20 px-6 border-b border-white/20 bg-teal-900/30 backdrop-blur-sm">
        <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 w-full">
            <div class="flex-shrink-0">
                <svg class="w-10 h-10 text-teal-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M2 17L12 22L22 17" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M2 12L12 17L22 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    <rect x="9" y="5" width="6" height="6" rx="1" fill="currentColor" fill-opacity="0.2"/>
                    <path d="M12 4V8M10 6H14" stroke="white" stroke-width="1.5" stroke-linecap="round"/>
                </svg>
            </div>
    ...
    <div class="flex-1 overflow-y-auto custom-scrollbar px-4 py-6">
        <nav class="space-y-8">
            ...
            <div>
                <p class="px-3 mb-3 text-xs font-bold tracking-widest text-teal-200/70 uppercase">Returns</p>
                <div class="space-y-1">
                    <a href="{{ route('returns.sales.index') }}" 
                       class="nav-item {{ request()->routeIs('returns.sales.*') ? 'nav-item-active' : '' }}">
                        <svg class="w-5 h-5 mr-3 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <a href="{{ route('returns.purchases.index') }}" 
                       class="nav-item {{ request()->routeIs('returns.purchases.*') ? 'nav-item-active' : '' }}">
                        <svg class="w-5 h-5 mr-3 opacity-80" fill="none" viewBox="0 0 24 24" stroke="currentColor">
