...
<head>
    ...
    <title>{{ config('app.name', 'MediStock') }} - Register</title>
    ...
    <div class="w-full max-w-6xl mx-auto p-6 relative z-10 flex flex-col md:flex-row items-center gap-12 lg:gap-24">
        <div class="w-full md:w-1/2 text-white flex flex-col justify-center">
            ...
            <h2 class="text-5xl lg:text-6xl font-extrabold mb-6 leading-tight tracking-tight">
                Join us today & <br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400">grow your business.</span>
            </h2>
            <p class="text-slate-400 text-lg max-w-md mb-10 leading-relaxed">
                Create a new account to access our powerful inventory management tools. Streamline your sales, track stock, and manage everything in one place.
            </p>
            ...
            <div class="glass-panel rounded-[2rem] p-8 md:p-10 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] relative overflow-hidden">
                ...
                <form method="POST" action="{{ route('register') }}" class="relative z-10">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative group">
                            ...
                            <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" 
                                   class="input-glass w-full rounded-xl py-3 pl-11 pr-4 text-sm font-medium tracking-wide" placeholder="John Doe">
                        </div>
                        <x-input-error :messages="$errors->get('name')" class="mt-2 text-red-400 text-sm bg-red-400/10 p-2 rounded border border-red-400/20" />
                    </div>
                    <div class="mb-5">
                        ...
                        <div class="relative group">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="username" 
                                   class="input-glass w-full rounded-xl py-3 pl-11 pr-4 text-sm font-medium tracking-wide" placeholder="user@example.com">
                        </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative group">
                            ...
                            <input id="password" type="password" name="password" required autocomplete="new-password" 
                                   class="input-glass w-full rounded-xl py-3 pl-11 pr-4 text-sm font-medium tracking-wide" placeholder="••••••••">
                        </div>
                    ...
                    <div class="mb-8">
                        ...
                        <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2 text-red-400 text-sm bg-red-400/10 p-2 rounded border border-red-400/20" />
                    </div>
                    ...
                    <div class="mt-8 text-center text-sm text-slate-400">
                        ...
                        <a href="{{ route('login') }}" class="text-white font-medium hover:text-indigo-400 transition-colors underline decoration-white/20 underline-offset-4 hover:decoration-indigo-400">Log in here</a>
                    </div>
                    @endif
                </form>
            </div>
