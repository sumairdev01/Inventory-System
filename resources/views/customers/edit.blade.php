    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight">Edit Customer</h2>
                    <p class="mt-2 text-sm text-gray-600">Update information for <span class="font-bold text-indigo-600">{{ $customer->name }}</span>.</p>
                </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <textarea name="address" id="address" rows="3"
                                              class="block w-full pl-11 pr-4 py-3.5 border border-gray-200 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all outline-none text-gray-700 placeholder-gray-400">{{ old('address', $customer->address) }}</textarea>
                                </div>
